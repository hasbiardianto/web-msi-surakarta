<a href="/auth/google" class=" flex justify-center items-center">
    <x-button class="flex w-full justify-center mt-2 mb-8 bg-transparent shadow border-slate-300 group gap-4">
        ...
        <span class="text-black group-hover:text-slate-100">
